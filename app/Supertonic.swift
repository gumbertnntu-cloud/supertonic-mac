            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                section(
                    ...
                    rows: [
                        ...
                        ("первый запуск", "F5 скачает ~1.4 ГБ модели при первом синтезе. Дальше быстрее, но всё равно 5–15 сек на фразу."),
                        ("языки", "F5 многоязычен — работает с русским, английским, китайским и др. Качество русского зависит от качества образца."),
                    ],
